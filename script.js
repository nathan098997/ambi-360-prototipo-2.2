...
function createProjectCard(name, project) {
    ...
    const publicLink = generatePublicLink(name);
    ...
    card.innerHTML = `
        ...
        <div class="project-info">
            ...
            <div class="project-link">
                <input type="text" value="${publicLink}" readonly class="public-link-input" id="link-${name}">
...
// CONFIGURAÇÃO DE URL PÚBLICA - Configure aqui a URL do seu GitHub Pages
...
function copyPublicLink(projectName) {
    ...
    try {
        ...
        navigator.clipboard.writeText(linkInput.value).then(() => {
            ...
            showToast('Erro ao copiar link. Copie manualmente.', 'warning');
        });
    }
}